...
public class AddressController {
    ...
    /**
     * This method handles get all Address  request.It takes the authorization & produces response
    ...
    /**
     * This method handles delete  Address  request.It takes the authorization and path variables address UUID
    ...
    /**
     * This method handles States request. It produces response in StatesListResponse and returns UUID & stateName,
     * if error Return error code and error Message.
     *
